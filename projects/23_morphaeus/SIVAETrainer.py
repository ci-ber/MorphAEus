...
class PTrainer(Trainer):
    ...
    def __init__(self, training_params, model, data, device, log_wandb=True):
        ...
        self.e_scheduler = MultiStepLR(self.optimizer_e, milestones=(350,), gamma=0.1)
        self.d_scheduler = MultiStepLR(self.optimizer_d, milestones=(350,), gamma=0.1)
    ...
    def test(self, model_weights, test_data, task='Val', opt_weights=None, epoch=0):
        ...
        with torch.no_grad():
            for data in test_data:
                ...
                loss_prec = self.criterion_MSE(x_, x)
